...
console.log("btn")
    ...
    $("#step-"+stepActual).attr("data-anim","hide-to--left");
...
{/*           
 <input id="next-home-buy-process" type='button' value='Continue' tabIndex="11" className="btn-success form-control btn-next" />
           */}
           ...
           <a href="#" id="next-home-buy-process" className="btn-back"><img class="" src={backbt}/></a>

         </li>
         <li>
           
             <a href="#" id="back-home-buy-process" className="btn-next"><img class="img-responsive " src={nextbt}/></a>
